...
int main(void)
{
    ...
    //glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE); // abandon 3.3 core profile
    ...
    GLuint programID = LoadShaders("../tutorial13_normal_mapping/NormalMapping.vertexshader", "../tutorial13_normal_mapping/NormalMapping.fragmentshader");
