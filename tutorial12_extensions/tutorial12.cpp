...
int main(void)
{
    ...
    GLuint programID = LoadShaders("../tutorial12_extensions/StandardShading.vertexshader",
    ...
    // Load the texture
    GLuint Texture = loadDDS("../tutorial12_extensions/uvmap.DDS");
    ...
    bool res = loadOBJ("../tutorial12_extensions/suzanne.obj", vertices, uvs, normals);
